  ...
  return (
    <>
      ...
      <p>In het kader van de innovatieroute konden derdejaarsstudenten kiezen uit vijf verschillende innovatieroutes. Ik koos voor de innovatieroute Low Code omdat ik mijn kennis op het gebied van applicatieontwikkeling wilde vergroten. Het doel van deze innovatieroute was om ons uit te leggen wat low-code is en hoe we met behulp van verschillende low-code platformen gemakkelijk applicaties kunnen ontwikkelen.
        ...
        <br></br><br></br>Op donderdag 20 oktober was de laatste sessie van de innovatieroute. De voormiddag stond in het teken van Mendix, gepresenteerd door Aqsa Intizar en Raf Swiggers van Apvine. Mendix is een low-code platform dat zich richt op applicaties voor ondernemingen en grote organisaties. We leerden hoe we met behulp van Mendix een applicatie konden maken die sponsors aan evenementen kon linken. We leerden hoe we entiteiten, pagina's en microflows konden maken en hoe we deze konden koppelen aan elkaar. Ook hier was het opvallend hoe snel we een werkende applicatie konden maken zonder programmeerkennis.
        <br></br><br></br>In de namiddag kregen we een presentatie over Oracle Apex van Olivier Van de Perre van iAdvise. Oracle Apex is een low-code platform dat zich richt op het ontwikkelen van webapplicaties en bedrijfsoplossingen. Olivier legde ons uit hoe we met behulp van Apex een applicatie konden ontwikkelen en hoe we deze konden hosten op de Oracle-cloud. Hij liet ons ook enkele voorbeelden zien van applicaties die met Oracle Apex waren ontwikkeld.
