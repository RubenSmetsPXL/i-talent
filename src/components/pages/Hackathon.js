  ...
  return (
    <>
      ...
      <p>De hackathon Fruit At Work werd georganiseerd op 26 november 2022 door AI by Example en Fruit At Work. Fruit At Work is een bedrijf dat fruitmanden levert aan andere bedrijven. Het doel van de hackathon was om met behulp van artificiële intelligentie voedselverspilling tegen te gaan. Tijdens de hackathon wilde ik mijn kennis over neurale netwerken, die ik tijdens mijn lessen had opgedaan, toepassen en uitbreiden. Dit was eveneens het doel van mijn groepsgenoten Liam Huygen en Wout Struys.
        ...
        <br></br><br></br>Elke groep moest praten over hun manier van aanpak en de vooruitgang die ze hadden geboekt. Hier hoorden we dat er een aantal groepen nog niet zo veel hadden, aangezien ze nog geen uitgebreide kennis hadden over artificiële intelligentie en neurale netwerken. Het was interessant om te zien hoe elke groep een andere aanpak had en we hebben veel geleerd van de andere groepen.
        ...
        <br></br><br></br>De Fruit At Work hackathon was een zeer fijne ervaring waarin ik mijn kennis over neurale netwerken van in de les kon toepassen en zelfs uitbreiden. Het was geweldig om samen te werken met Liam en Wout en te zien hoe we ons eigen neuraal netwerk konden trainen om voedselverspilling tegen te gaan. Door het trainen van het neuraal netwerk hebben we veel geleerd over het belang van het voorbewerken van de data en het kiezen van de juiste architectuur.
